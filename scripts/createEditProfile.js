...
export const createEditProfile = async (login) => {
    ...
    const btnDeleteAvatar = createElement('button', {
        ...
        innerHTML: `
            <svg class="edit__icon-avatar" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M9.48842 29.6389C9.48842 31.35 10.9027 32.75 12.6313 32.75H25.2027C26.9313 32.75 28.3456 31.35 28.3456 29.6389V10.9722H9.48842V29.6389ZM12.6313 14.0833H25.2027V29.6389H12.6313V14.0833ZM24.417 6.30556L22.8456 4.75H14.9884L13.417 6.30556H7.91699V9.41667H29.917V6.30556H24.417Z" fill="white" />
            </svg>
            Удалить `,
    });
    ...
    const editDescriptionTextArea = createElement('textarea', {
        ...
        name: 'description',
        id: 'description',
        value: user.description ?? 'Здесь будут описание',
    });
